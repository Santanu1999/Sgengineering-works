...
export default function ReceivePaymentModal({ customer, onClose, onSave }: ReceivePaymentModalProps) {
  ...
  return (
    <div id="payment-form-backdrop" className="fixed inset-0 bg-slate-900/60 flex items-start justify-center z-45 p-4 backdrop-blur-xs font-sans overflow-y-auto">
